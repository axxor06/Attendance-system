...
const userSchema = new Schema(
  {
    ...
    // Set while an email-change request is awaiting OTP confirmation
    // (see authController.requestEmailChange/confirmEmailChange). The
    // account's real `email` is never overwritten until that address is
    // proven to be reachable by its owner, and select:false keeps it out
    // of ordinary reads until a route explicitly opts in.
    pendingEmail: {
      type: String,
      default: null,
      lowercase: true,
