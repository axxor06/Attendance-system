...
router.use(protect);
router.patch('/me', rejectUnknownBodyFields(['name', 'phone', 'dateOfBirth', 'designation', 'qualification', 'admissionYear', 'avatarUrl', 'employeeId', 'department', 'departmentChangeConfirmed']), v.updateMeValidator, validate, authController.updateMe);
router.get('/me', authController.getMe);
router.post('/me/email-change', otpGenerateLimiter, rejectUnknownBodyFields(['newEmail']), v.requestEmailChangeValidator, validate, authController.requestEmailChange);
router.post('/me/email-change/confirm', otpVerifyLimiter, rejectUnknownBodyFields(['otp']), v.confirmEmailChangeValidator, validate, authController.confirmEmailChange);
router.post('/me/email-change/cancel', rejectUnknownBodyFields([]), authController.cancelEmailChange);
