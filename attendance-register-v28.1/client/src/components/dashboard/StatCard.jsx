...
const ACCENT_STYLES = {
  ink: { icon: 'bg-indigo/10 text-ink', line: 'bg-indigo' },
...
export default function StatCard({ label, value, sublabel, icon: Icon, accent = 'ink', trend, percentage }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -3, boxShadow: '0 16px 36px rgba(79,70,165,0.1)' }}
      transition={{ duration: 0.2, ease: [0.23, 1, 0.32, 1] }}
      className="relative overflow-hidden rounded-xl border border-line bg-cream p-5 shadow-[0_8px_24px_rgba(79,70,165,0.06)]"
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {Icon && (
          <div className={clsx('flex h-11 w-11 shrink-0 items-center justify-center rounded-lg', styles.icon)}>
      ...
      {percentage !== undefined && (
        <div className="mt-5">
          ...
          <div className="h-1.5 w-full overflow-hidden rounded-full bg-indigo/8">
            <motion.div
