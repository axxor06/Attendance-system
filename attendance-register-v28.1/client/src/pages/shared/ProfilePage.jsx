...
export default function ProfilePage() {
  ...
  const [form, setForm] = useState({ email: user?.email || '', phone: user?.phone || '', employeeId: user?.employeeId || '', dateOfBirth: user?.dateOfBirth || '', designation: user?.designation || '', qualification: user?.qualification || '', admissionYear: user?.admissionYear || '', avatarUrl: user?.avatarUrl || '', department: user?.department?._id || '' });
  ...
  function startEditing() {
    setForm({ email: user?.email || '', phone: user?.phone || '', employeeId: user?.employeeId || '', dateOfBirth: user?.dateOfBirth || '', designation: user?.designation || '', qualification: user?.qualification || '', admissionYear: user?.admissionYear || '', avatarUrl: user?.avatarUrl || '', department: user?.department?._id || '', name: user?.name || '' });
    setError('');
    setIsEditing(true);
  }
