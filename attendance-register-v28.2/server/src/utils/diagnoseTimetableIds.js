...
try {
  ...
  console.error('Timetable ID diagnosis failed.', {
    category: 'TIMETABLE_ID_DIAGNOSTIC_FAILURE',
    errorCode: typeof error?.code === 'string' ? error.code.slice(0, 80) : 'DIAGNOSTIC_ERROR',
  });
  process.exitCode = 1;
} finally {
